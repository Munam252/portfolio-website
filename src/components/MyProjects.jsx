  ...
  return (
    <section id="projects" className="py-20 bg-gradient-to-br from-white to-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <h2 className="text-4xl font-bold text-green-600 mb-4">My Projects</h2>
          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="flex flex-col lg:flex-row">
                {/* Project Content */}
                <div className="lg:w-full p-8 text-center">
                  <div className="flex flex-col items-center mb-6">
                    ...
                    <div>
                      ...
                      {project.shortTitle && (
                        <p className="text-lg text-gray-500 mb-6">{project.shortTitle}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="max-w-3xl mx-auto">
                    ...
                    {project.tools && project.tools.length > 0 && (
                      <div className="mb-8">
                        <h4 className="font-semibold text-gray-700 mb-4 text-xl">Tools & Technologies</h4>
                        <div className="flex flex-wrap justify-center gap-3">
                          {project.tools.map((tool, i) => (
                            <span 
                              key={i} 
                              className="bg-gray-100 text-gray-800 px-4 py-2 rounded-full text-sm font-medium shadow-sm hover:bg-green-50 hover:text-green-600 transition-all"
                            >
                              {tool}
                            </span>
                          ))}
                    ...
                    <motion.a
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-lg hover:from-green-600 hover:to-green-700 transition-all duration-300 shadow-lg text-lg font-medium"
                    >
